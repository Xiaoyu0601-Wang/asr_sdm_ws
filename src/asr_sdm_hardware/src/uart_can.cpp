...
*********************************************************************************************************/
bool UART_CAN::spiTransfer(uint8_t byte_number, unsigned char * tx_buf, unsigned char * rx_buf)
{
...
*********************************************************************************************************/
// bool UART_CAN::setupInterruptGpio()
// {
// 	wiringPiSetup();
...
*********************************************************************************************************/
bool UART_CAN::resetMCP2515(void)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::mcp2515_readRegister(const uint8_t address)
{
  uint8_t rx_buf[3] = {0};
...
*********************************************************************************************************/
void UART_CAN::mcp2515_readRegisterS(const uint8_t address, uint8_t values[], const uint8_t n)
{
  uint8_t i;
...
*********************************************************************************************************/
void UART_CAN::mcp2515_setRegister(const uint8_t address, const uint8_t value)
{
...
*********************************************************************************************************/
void UART_CAN::mcp2515_setRegisterS(const uint8_t address, const uint8_t values[], const uint8_t n)
{
  int buf_size = 3 + n;
...
*********************************************************************************************************/
void UART_CAN::mcp2515_modifyRegister(const uint8_t address, const uint8_t mask, const uint8_t data)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::mcp2515_readStatus(void)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::mcp2515_setCANCTRL_Mode(const uint8_t newmode)
{
  // mcp2515_modifyRegister(UART_CANCTRL, MODE_MASK, newmode);
  mcp2515_setRegister(UART_CANCTRL, newmode);
  rclcpp::sleep_for(std::chrono::milliseconds(1));
  uint8_t mode_status = mcp2515_readRegister(UART_CANCTRL);
...
*********************************************************************************************************/
uint8_t UART_CAN::mcp2515_configRate(const uint8_t canSpeed, const uint8_t canClock)
{
...
*********************************************************************************************************/
void UART_CAN::mcp2515_initCANBuffers(void)
{
  uint8_t i, a1, a2, a3;
  ...
  const uint8_t canIDMode, const uint8_t canSpeed, const uint8_t canClock)
{
  ...
  uint8_t dummy = mcp2515_readRegister(UART_CANSTAT);
  ...
  /* interrupt mode               */
  mcp2515_setRegister(UART_CANINTF, 0x00);
  mcp2515_setRegister(UART_CANINTE, 0x01);  // MCP_RX0IF);  // | MCP_RX1IF);
  ...
  dummy = mcp2515_readRegister(UART_CANSTAT);
  RCLCPP_INFO(rclcpp::get_logger("hardware"), "UART_CANSTAT: %#04x", dummy);
  // if (dummy == 0) {
...
*********************************************************************************************************/
void UART_CAN::mcp2515_write_id(const uint8_t mcp_addr, const uint8_t ext, const uint32_t id)
{
  uint16_t canid;
  uint8_t tbufdata[4];
...
*********************************************************************************************************/
void UART_CAN::mcp2515_write_mf(const uint8_t mcp_addr, const uint8_t ext, const uint32_t id)
{
  uint16_t canid;
  uint8_t tbufdata[4];
...
*********************************************************************************************************/
void UART_CAN::mcp2515_read_id(const uint8_t mcp_addr, uint8_t * ext, uint32_t * id)
{
  uint8_t tbufdata[4];
...
*********************************************************************************************************/
void UART_CAN::mcp2515_write_canMsg(const uint8_t buffer_sidh_addr)
{
  uint8_t mcp_addr;
...
*********************************************************************************************************/
void UART_CAN::mcp2515_read_canMsg(const uint8_t buffer_sidh_addr) /* read can msg */
{
  uint8_t ctrl;
  uint8_t mcp_addr;
...
*********************************************************************************************************/
uint8_t UART_CAN::mcp2515_getNextFreeTXBuf(uint8_t * txbuf_address) /* get Next free txbuf */
{
  uint8_t i, ctrlval;
...
/*********************************************************************************************************
** Function name:           UART_CAN
** Descriptions:            Public function to declare CAN class and the /CS pin.
*********************************************************************************************************/
// void UART_CAN::init_Para(int spi_channel, int spi_baudrate, uint8_t gpio_can_interrupt, uint8_t
// gpio_can_cs)
// {
...
*********************************************************************************************************/
uint8_t UART_CAN::initCAN(uint8_t idmodeset, uint8_t speedset, uint8_t clockset)
{
  uint8_t res;
...
// uint8_t UART_CAN::begin(uint8_t idmodeset, uint8_t speedset, uint8_t clockset)
// {
//     uint8_t res;
...
*********************************************************************************************************/
uint8_t UART_CAN::init_Mask(uint8_t num, uint8_t ext, uint32_t ulData)
{
...
** Descriptions:            Public function to set mask(s).
*********************************************************************************************************/
uint8_t UART_CAN::init_Mask(uint8_t num, uint32_t ulData)
{
  uint8_t res = MCP2515_OK;
  uint8_t ext = 0;
...
*********************************************************************************************************/
uint8_t UART_CAN::init_Filt(uint8_t num, uint8_t ext, uint32_t ulData)
{
  uint8_t res = MCP2515_OK;
...
** Descriptions:            Public function to set filter(s).
*********************************************************************************************************/
uint8_t UART_CAN::init_Filt(uint8_t num, uint32_t ulData)
{
  uint8_t res = MCP2515_OK;
  uint8_t ext = 0;
...
*********************************************************************************************************/
void UART_CAN::mcp2515_send(uint32_t canid, uint8_t * buf, uint8_t len)
{
...
uint8_t UART_CAN::readMsg()
{
  ...
  if (stat & MCP_STAT_RX0IF) /* Msg in Buffer 0              */
  {
    ...
    mcp2515_modifyRegister(UART_CANINTF, MCP_RX0IF, 0);
    res = CAN_OK;
  } else if (stat & MCP_STAT_RX1IF) /* Msg in Buffer 1              */
  {
    mcp2515_read_canMsg(MCP_RXBUF_1);
    mcp2515_modifyRegister(UART_CANINTF, MCP_RX1IF, 0);
    res = CAN_OK;
  } else {
    res = CAN_NOMSG;
  }
...
*interrupt output)
*********************************************************************************************************/
uint8_t UART_CAN::checkReceive(void)
{
  uint8_t res;
...
*********************************************************************************************************/
uint8_t UART_CAN::checkError(void)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::getError(void)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::errorCountRX(void)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::errorCountTX(void)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::enOneShotTX(void)
{
  uint8_t value;
  mcp2515_modifyRegister(UART_CANCTRL, MODE_ONESHOT, MODE_ONESHOT);
  value = mcp2515_readRegister(UART_CANCTRL);
...
*********************************************************************************************************/
uint8_t UART_CAN::disOneShotTX(void)
{
  uint8_t value;
  mcp2515_modifyRegister(UART_CANCTRL, MODE_ONESHOT, 0);
  value = mcp2515_readRegister(UART_CANCTRL);
...
*********************************************************************************************************/
uint8_t UART_CAN::queryCharger(float voltage, float current, int address, int charge)
{
...
*********************************************************************************************************/
uint8_t UART_CAN::queryBMS(int moduleID, int shuntVoltageMillivolts)
{
