...
// If DBoW2 is not available, build will proceed but BoW functionality is disabled.
#if __has_include(<DBoW2/DBoW2.h>)
#include <DBoW2/DBoW2.h>
#define ASR_SDM_HAVE_DBOW2 1
#else
#define ASR_SDM_HAVE_DBOW2 0
#endif
...
// DBoW2 not available: declare minimal stubs so dependent code can still compile
namespace DBoW2 {
  class OrbVocabulary {};
  class BowVector {};
  enum WeightingType {};
...
using OrbVocabulary = DBoW2::OrbVocabulary;

#endif // ASR_SDM_HAVE_DBOW2
