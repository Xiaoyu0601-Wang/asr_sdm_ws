...
def generate_launch_description():
    ...
    calib_yaml_arg = DeclareLaunchArgument(
        'calib_yaml',
        default_value=PathJoinSubstitution([pkg_share, 'share', 'asr_sdm_ros2', 'param', 'calib', 'fla_stereo_imu.yaml']),
    ...
    vio_node = Node(
        package='asr_sdm_ros2', executable='vio_frontend_stereo_ros2', name='vio_frontend_stereo_ros2', output='screen',
